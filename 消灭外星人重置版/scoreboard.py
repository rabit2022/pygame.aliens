...
class Scoreboard(object):
    # 显示得分信息的类
    def __init__(self, ai_settings, screen, stats, alien_group, ship_bullet_group, alien_bullet_group):
        '''
        报告我们跟踪的值
        初始化显示得分涉及的属性
        :param ai_settings:
        ...
        # 显示得分信息时使用的字体设置
        self.text_color = self.ai_settings.text_color  # 文本颜色
        self.font = pygame.font.SysFont(self.ai_settings.font, 48)  # 实例化一个字体对象
        self.prep_images()
    ...
    def prep_ships(self):
        ...
        for ship_number in range(self.stats.ships_left):
            # 创建一艘新飞船
            ship = Ship(self.ai_settings, self.screen, self.stats, self, self.alien_group, self.ship_bullet_group,
                        self.alien_bullet_group, self)
